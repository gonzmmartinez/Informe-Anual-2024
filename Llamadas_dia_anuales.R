...
# Guardar gráfico
ggsave(filename="Llamadas_911_dia_anuales.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=8, height=4.5)
ggsave(filename="Llamadas_911_dia_anuales.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
