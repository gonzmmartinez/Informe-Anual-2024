...
# Guardar gráfico
ggsave(filename="Requerimientos_911_evolucion.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=12, height=7)

ggsave(filename="Requerimientos_911_evolucion.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
