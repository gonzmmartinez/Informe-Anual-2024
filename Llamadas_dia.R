...
# Guardar gráfico
ggsave(filename="Llamadas_911_dia.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=10, height=4.5)
ggsave(filename="Llamadas_911_dia.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
