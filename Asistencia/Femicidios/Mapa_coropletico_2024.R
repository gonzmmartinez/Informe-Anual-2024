...
# Guardar gráfico
ggsave(filename="Mapa_coropletico.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=Mapa_cor, dpi=100, width=9, height=6)
ggsave(filename="Mapa_coropletico.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
