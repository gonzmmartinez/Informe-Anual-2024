...
# Crear datos
Raw <- data.frame(Categorias = c("Sí", "No", "Sin dato"),
                   Cantidad = c(5, 4, 1))
...
# Guardar gráfico
ggsave(filename="Femicidios_antecedentes.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=7, height=5)
ggsave(filename="Femicidios_antecedentes.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
