...
# Guardar gráfico
ggsave(filename="Llamadas_911_horas.png", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/PNG/"),
       plot=grafico, dpi=100, width=13, height=5)
ggsave(filename="Llamadas_911_horas.svg", path=paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/Graficos/SVG/"),
